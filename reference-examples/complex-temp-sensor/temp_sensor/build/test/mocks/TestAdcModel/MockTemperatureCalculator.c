...
static struct MockTemperatureCalculatorInstance
{
  ...
  char TemperatureCalculator_Calculate_CallbackBool;
  CMOCK_TemperatureCalculator_Calculate_CALLBACK TemperatureCalculator_Calculate_CallbackFunctionPointer;
  int TemperatureCalculator_Calculate_CallbackCalls;
...
void MockTemperatureCalculator_Verify(void)
{
  ...
  if (Mock.TemperatureCalculator_Calculate_CallbackFunctionPointer != NULL)
  {
    call_instance = CMOCK_GUTS_NONE;
    (void)call_instance;
  }
...
float TemperatureCalculator_Calculate(uint16 millivolts)
{
  ...
  if (!Mock.TemperatureCalculator_Calculate_CallbackBool &&
      Mock.TemperatureCalculator_Calculate_CallbackFunctionPointer != NULL)
  {
    float cmock_cb_ret = Mock.TemperatureCalculator_Calculate_CallbackFunctionPointer(millivolts, Mock.TemperatureCalculator_Calculate_CallbackCalls++);
    UNITY_CLR_DETAILS();
    return cmock_cb_ret;
  }
  ...
  if (Mock.TemperatureCalculator_Calculate_CallbackFunctionPointer != NULL)
  {
    cmock_call_instance->ReturnVal = Mock.TemperatureCalculator_Calculate_CallbackFunctionPointer(millivolts, Mock.TemperatureCalculator_Calculate_CallbackCalls++);
  }
  UNITY_CLR_DETAILS();
  return cmock_call_instance->ReturnVal;
}
...
{
  Mock.TemperatureCalculator_Calculate_IgnoreBool = (char)0;
  Mock.TemperatureCalculator_Calculate_CallbackBool = (char)1;
  Mock.TemperatureCalculator_Calculate_CallbackFunctionPointer = Callback;
}

void TemperatureCalculator_Calculate_Stub(CMOCK_TemperatureCalculator_Calculate_CALLBACK Callback)
{
  Mock.TemperatureCalculator_Calculate_IgnoreBool = (char)0;
  Mock.TemperatureCalculator_Calculate_CallbackBool = (char)0;
  Mock.TemperatureCalculator_Calculate_CallbackFunctionPointer = Callback;
}
