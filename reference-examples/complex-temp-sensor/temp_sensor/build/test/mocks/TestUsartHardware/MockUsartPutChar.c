...
static struct MockUsartPutCharInstance
{
  ...
  char Usart_PutChar_CallbackBool;
  CMOCK_Usart_PutChar_CALLBACK Usart_PutChar_CallbackFunctionPointer;
  int Usart_PutChar_CallbackCalls;
...
void MockUsartPutChar_Verify(void)
{
  ...
  if (Mock.Usart_PutChar_CallbackFunctionPointer != NULL)
  {
    call_instance = CMOCK_GUTS_NONE;
    (void)call_instance;
  }
...
void Usart_PutChar(char data)
{
  ...
  if (!Mock.Usart_PutChar_CallbackBool &&
      Mock.Usart_PutChar_CallbackFunctionPointer != NULL)
  {
    Mock.Usart_PutChar_CallbackFunctionPointer(data, Mock.Usart_PutChar_CallbackCalls++);
    UNITY_CLR_DETAILS();
    return;
  }
...
{
  Mock.Usart_PutChar_IgnoreBool = (char)0;
  Mock.Usart_PutChar_CallbackBool = (char)1;
  Mock.Usart_PutChar_CallbackFunctionPointer = Callback;
}

void Usart_PutChar_Stub(CMOCK_Usart_PutChar_CALLBACK Callback)
{
  Mock.Usart_PutChar_IgnoreBool = (char)0;
  Mock.Usart_PutChar_CallbackBool = (char)0;
  Mock.Usart_PutChar_CallbackFunctionPointer = Callback;
}
