...
int main(void)
{
  ...
  run_test(testInitShouldDelegateToConfiguratorAndTemperatureSensor, "testInitShouldDelegateToConfiguratorAndTemperatureSensor", 22);
  run_test(testGetSampleCompleteShouldReturn_FALSE_WhenTemperatureSensorSampleReadyReturns_FALSE, "testGetSampleCompleteShouldReturn_FALSE_WhenTemperatureSensorSampleReadyReturns_FALSE", 32);
  run_test(testGetSampleCompleteShouldReturn_TRUE_WhenTemperatureSensorSampleReadyReturns_TRUE, "testGetSampleCompleteShouldReturn_TRUE_WhenTemperatureSensorSampleReadyReturns_TRUE", 38);
  run_test(testGetSampleShouldDelegateToAdcTemperatureSensor, "testGetSampleShouldDelegateToAdcTemperatureSensor", 44);
