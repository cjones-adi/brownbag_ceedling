...
int main(void)
{
  ...
  run_test(testInitShouldConfigureUsartPeripheralByCallingConfiguratorAppropriately, "testInitShouldConfigureUsartPeripheralByCallingConfiguratorAppropriately", 22);
  run_test(testTransmitStringShouldSendDesiredStringOutUsingUsart, "testTransmitStringShouldSendDesiredStringOutUsingUsart", 34);
