...
int main(void)
{
  ...
  run_test(testInitShouldCallHardwareInit, "testInitShouldCallHardwareInit", 23);
  run_test(testRunShouldGetSystemTimeAndPassOnToModelForEventScheduling, "testRunShouldGetSystemTimeAndPassOnToModelForEventScheduling", 30);
