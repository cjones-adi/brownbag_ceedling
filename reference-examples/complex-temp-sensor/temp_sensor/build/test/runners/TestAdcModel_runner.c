...
int main(void)
{
  ...
  run_test(testDoGetSampleShouldReturn_FALSE_WhenTaskSchedulerReturns_FALSE, "testDoGetSampleShouldReturn_FALSE_WhenTaskSchedulerReturns_FALSE", 23);
  run_test(testDoGetSampleShouldReturn_TRUE_WhenTaskSchedulerReturns_TRUE, "testDoGetSampleShouldReturn_TRUE_WhenTaskSchedulerReturns_TRUE", 29);
  run_test(testProcessInputShouldDelegateToTemperatureCalculatorAndPassResultToFilter, "testProcessInputShouldDelegateToTemperatureCalculatorAndPassResultToFilter", 35);
