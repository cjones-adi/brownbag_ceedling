...
# 11 "test/adc/TestAdcModel.c" 2
# 1 "build/test/mocks/TestAdcModel/MockTaskScheduler.h" 1
...
# 7 "build/test/mocks/TestAdcModel/MockTaskScheduler.h" 2
...
# 12 "test/adc/TestAdcModel.c" 2
# 1 "build/test/mocks/TestAdcModel/MockTemperatureCalculator.h" 1
/* AUTOGENERATED FILE. DO NOT EDIT. */

#define _MOCKTEMPERATURECALCULATOR_H 


# 1 "src/TemperatureCalculator.h" 1
/* =========================================================================
    Ceedling - Test-Centered Build System for C
    ThrowTheSwitch.org
    Copyright (c) 2010-25 Mike Karlesky, Mark VanderVoord, & Greg Williams
...
# 7 "build/test/mocks/TestAdcModel/MockTemperatureCalculator.h" 2
...
#define TemperatureCalculator_Calculate_Ignore() TEST_FAIL_MESSAGE("TemperatureCalculator_Calculate requires _IgnoreAndReturn");
...
#define TemperatureCalculator_Calculate_Expect(millivolts) TEST_FAIL_MESSAGE("TemperatureCalculator_Calculate requires _ExpectAndReturn");
...
typedef float (* CMOCK_TemperatureCalculator_Calculate_CALLBACK)(uint16 millivolts, int cmock_num_calls);
void TemperatureCalculator_Calculate_AddCallback(CMOCK_TemperatureCalculator_Calculate_CALLBACK Callback);
void TemperatureCalculator_Calculate_Stub(CMOCK_TemperatureCalculator_Calculate_CALLBACK Callback);
#define TemperatureCalculator_Calculate_StubWithCallback TemperatureCalculator_Calculate_Stub
...
# 13 "test/adc/TestAdcModel.c" 2
# 1 "build/test/mocks/TestAdcModel/MockTemperatureFilter.h" 1
/* AUTOGENERATED FILE. DO NOT EDIT. */
...
# 7 "build/test/mocks/TestAdcModel/MockTemperatureFilter.h" 2
