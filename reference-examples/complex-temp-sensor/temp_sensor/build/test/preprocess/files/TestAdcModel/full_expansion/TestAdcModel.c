...
# 86 "build/test/mocks/TestAdcModel/MockTaskScheduler.h"
...
void TemperatureCalculator_Calculate_CMockIgnoreAndReturn(UNITY_UINT cmock_line, float cmock_to_return);

void TemperatureCalculator_Calculate_CMockStopIgnore(void);


void TemperatureCalculator_Calculate_CMockExpectAndReturn(UNITY_UINT cmock_line, uint16 millivolts, float cmock_to_return);
...
# 50 "build/test/mocks/TestAdcModel/MockTemperatureCalculator.h"
#pragma GCC diagnostic pop
...
# 74 "build/test/mocks/TestAdcModel/MockTemperatureFilter.h"
#pragma GCC diagnostic pop
...
void testDoGetSampleShouldReturn_FALSE_WhenTaskSchedulerReturns_FALSE(void)
{
  ...
  do { if (!(AdcModel_DoGetSample())) { } else { UnityFail( ((" Expected FALSE Was TRUE")), (UNITY_UINT)((26))); } } while (0);
}

void testDoGetSampleShouldReturn_TRUE_WhenTaskSchedulerReturns_TRUE(void)
{
  TaskScheduler_DoAdc_CMockExpectAndReturn(31, (1));
  do { if ((AdcModel_DoGetSample())) { } else { UnityFail( ((" Expected TRUE Was FALSE")), (UNITY_UINT)((32))); } } while (0);
}
