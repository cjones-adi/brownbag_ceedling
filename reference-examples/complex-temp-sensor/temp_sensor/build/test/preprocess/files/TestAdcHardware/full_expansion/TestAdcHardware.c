...
# 13 "src/AdcHardwareConfigurator.h"
void Adc_Reset(void);
...
void Adc_Reset_CMockExpect(UNITY_UINT cmock_line);
...
void Adc_ConfigureMode_CMockExpect(UNITY_UINT cmock_line);
...
void Adc_EnableTemperatureChannel_CMockExpect(UNITY_UINT cmock_line);
...
# 74 "build/test/mocks/TestAdcHardware/MockAdcHardwareConfigurator.h"
...
void Adc_StartTemperatureSensorConversion_CMockExpect(UNITY_UINT cmock_line);
...
void Adc_TemperatureSensorSampleReady_CMockIgnoreAndReturn(UNITY_UINT cmock_line, bool cmock_to_return);

void Adc_TemperatureSensorSampleReady_CMockStopIgnore(void);


void Adc_TemperatureSensorSampleReady_CMockExpectAndReturn(UNITY_UINT cmock_line, bool cmock_to_return);
...
void Adc_ReadTemperatureSensor_CMockIgnoreAndReturn(UNITY_UINT cmock_line, uint16 cmock_to_return);

void Adc_ReadTemperatureSensor_CMockStopIgnore(void);


void Adc_ReadTemperatureSensor_CMockExpectAndReturn(UNITY_UINT cmock_line, uint16 cmock_to_return);
...
# 74 "build/test/mocks/TestAdcHardware/MockAdcTemperatureSensor.h"
#pragma GCC diagnostic pop
...
void testGetSampleCompleteShouldReturn_FALSE_WhenTemperatureSensorSampleReadyReturns_FALSE(void)
{
  ...
  do { if ((!AdcHardware_GetSampleComplete())) { } else { UnityFail( ((" Expression Evaluated To FALSE")), (UNITY_UINT)((35))); } } while (0);
}
...
void testGetSampleCompleteShouldReturn_TRUE_WhenTemperatureSensorSampleReadyReturns_TRUE(void)
{
  ...
  do { if ((AdcHardware_GetSampleComplete())) { } else { UnityFail( ((" Expression Evaluated To FALSE")), (UNITY_UINT)((41))); } } while (0);
}
...
# 50 "test/adc/TestAdcHardware.c" 3 4
 ((void *)0)
# 50 "test/adc/TestAdcHardware.c"
