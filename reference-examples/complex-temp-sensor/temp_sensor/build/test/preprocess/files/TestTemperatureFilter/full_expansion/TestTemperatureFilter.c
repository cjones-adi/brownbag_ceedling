# 0 "test/TestTemperatureFilter.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "test/TestTemperatureFilter.c"
...
# 9 "test/TestTemperatureFilter.c" 2
# 1 "src/Types.h" 1
# 14 "src/Types.h"
...
# 10 "test/TestTemperatureFilter.c" 2
# 1 "src/TemperatureFilter.h" 1
# 11 "src/TemperatureFilter.h"
# 1 "src/Types.h" 1
# 12 "src/TemperatureFilter.h" 2
...
# 11 "test/TestTemperatureFilter.c" 2
...
# 25 "test/TestTemperatureFilter.c" 3 4
 ((void *)0)
# 25 "test/TestTemperatureFilter.c"
...
# 32 "test/TestTemperatureFilter.c" 3 4
 ((void *)0)
# 32 "test/TestTemperatureFilter.c"
 ), (UNITY_UINT)(32));
...
# 36 "test/TestTemperatureFilter.c" 3 4
 ((void *)0)
# 36 "test/TestTemperatureFilter.c"
 ), (UNITY_UINT)(36));
}
...
void setValueAndVerifyResponse(float input, float response)
{
  ...
  if (input == +
# 45 "test/TestTemperatureFilter.c" 3 4
               (__builtin_inff ()) 
# 45 "test/TestTemperatureFilter.c"
                        ||
      input == -
# 46 "test/TestTemperatureFilter.c" 3 4
               (__builtin_inff ()) 
# 46 "test/TestTemperatureFilter.c"
                        ||
      
# 47 "test/TestTemperatureFilter.c" 3 4
     __builtin_isnan (
# 47 "test/TestTemperatureFilter.c"
     input
# 47 "test/TestTemperatureFilter.c" 3 4
     )
# 47 "test/TestTemperatureFilter.c"
...
# 49 "test/TestTemperatureFilter.c" 3 4
   ((void *)0)
# 49 "test/TestTemperatureFilter.c"
   ), (UNITY_UINT)(49), UNITY_FLOAT_IS_NEG_INF);
  }
  else
  {
    UnityAssertFloatsWithin((UNITY_FLOAT)((0.0001f)), (UNITY_FLOAT)((response)), (UNITY_FLOAT)((actual)), (
# 53 "test/TestTemperatureFilter.c" 3 4
   ((void *)0)
# 53 "test/TestTemperatureFilter.c"
   ), (UNITY_UINT)(53));
  }
}
...
# 76 "test/TestTemperatureFilter.c" 3 4
                                                (__builtin_inff ())
# 76 "test/TestTemperatureFilter.c"
                                                        );
...
# 82 "test/TestTemperatureFilter.c" 3 4
                                              (__builtin_inff ())
# 82 "test/TestTemperatureFilter.c"
                                                      );
  setInvalidTemperatureAndVerifyReinitialized(+
# 83 "test/TestTemperatureFilter.c" 3 4
                                              (__builtin_inff ())
# 83 "test/TestTemperatureFilter.c"
                                                      );
  setInvalidTemperatureAndVerifyReinitialized(+
# 84 "test/TestTemperatureFilter.c" 3 4
                                              (__builtin_nanf (""))
# 84 "test/TestTemperatureFilter.c"
                                                 );
  setInvalidTemperatureAndVerifyReinitialized(-
# 85 "test/TestTemperatureFilter.c" 3 4
                                              (__builtin_nanf (""))
# 85 "test/TestTemperatureFilter.c"
                                                 );
}
