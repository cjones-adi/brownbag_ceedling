...
# 74 "build/test/mocks/TestUsartModel/MockTemperatureFilter.h"
...
# 50 "build/test/mocks/TestUsartModel/MockUsartBaudRateRegisterCalculator.h"
#pragma GCC diagnostic pop
...
# 29 "test/TestUsartModel.c" 3 4
 ((void *)0)
# 29 "test/TestUsartModel.c"
...
# 35 "test/TestUsartModel.c" 3 4
 ((void *)0)
# 35 "test/TestUsartModel.c"
 ), (UNITY_UINT)(35));
}
...
# 40 "test/TestUsartModel.c" 3 4
 (__builtin_inff ())
# 40 "test/TestUsartModel.c"
 );
  UnityAssertEqualString((const char*)(("Temperature sensor failure!\n")), (const char*)((UsartModel_GetFormattedTemperature())), (
# 41 "test/TestUsartModel.c" 3 4
 ((void *)0)
# 41 "test/TestUsartModel.c"
 ), (UNITY_UINT)(41));
}
...
# 46 "test/TestUsartModel.c" 3 4
 ((void *)0)
# 46 "test/TestUsartModel.c"
 ), (UNITY_UINT)(46));
}
