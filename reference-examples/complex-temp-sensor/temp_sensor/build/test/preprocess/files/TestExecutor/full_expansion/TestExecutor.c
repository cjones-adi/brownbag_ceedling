...
void Model_Init_CMockExpect(UNITY_UINT cmock_line);
...
# 50 "build/test/mocks/TestExecutor/MockModel.h"
...
void UsartConductor_Init_CMockExpect(UNITY_UINT cmock_line);
...
void UsartConductor_Run_CMockExpect(UNITY_UINT cmock_line);
...
# 62 "build/test/mocks/TestExecutor/MockUsartConductor.h"
#pragma GCC diagnostic pop
...
void AdcConductor_Init_CMockExpect(UNITY_UINT cmock_line);
...
void AdcConductor_Run_CMockExpect(UNITY_UINT cmock_line);
...
void AdcConductor_JustHereToTest_CMockIgnoreAndReturn(UNITY_UINT cmock_line, bool cmock_to_return);

void AdcConductor_JustHereToTest_CMockStopIgnore(void);


void AdcConductor_JustHereToTest_CMockExpectAndReturn(UNITY_UINT cmock_line, bool cmock_to_return);
...
void AdcConductor_AlsoHereToTest_CMockIgnoreAndReturn(UNITY_UINT cmock_line, bool cmock_to_return);

void AdcConductor_AlsoHereToTest_CMockStopIgnore(void);


void AdcConductor_AlsoHereToTest_CMockExpectAndReturn(UNITY_UINT cmock_line, bool cmock_to_return);
...
void AdcConductor_YetAnotherTest_CMockIgnoreAndReturn(UNITY_UINT cmock_line, bool cmock_to_return);

void AdcConductor_YetAnotherTest_CMockStopIgnore(void);


void AdcConductor_YetAnotherTest_CMockExpectAndReturn(UNITY_UINT cmock_line, bool cmock_to_return);
...
# 98 "build/test/mocks/TestExecutor/MockAdcConductor.h"
#pragma GCC diagnostic pop
...
void TimerConductor_Init_CMockExpect(UNITY_UINT cmock_line);
...
void TimerConductor_Run_CMockExpect(UNITY_UINT cmock_line);
...
# 62 "build/test/mocks/TestExecutor/MockTimerConductor.h"
#pragma GCC diagnostic pop
...
void Interrupt_Enable_CMockExpect(UNITY_UINT cmock_line);
...
void Interrupt_Disable_CMockExpect(UNITY_UINT cmock_line);
...
# 62 "build/test/mocks/TestExecutor/MockIntrinsicsWrapper.h"
#pragma GCC diagnostic pop
...
void testRunShouldCallRunForEachConductorAndReturnTrueAlways(void)
{
  ...
  do { if ((Executor_Run())) { } else { UnityFail( ((" Expected TRUE Was FALSE")), (UNITY_UINT)((42))); } } while (0);
}
