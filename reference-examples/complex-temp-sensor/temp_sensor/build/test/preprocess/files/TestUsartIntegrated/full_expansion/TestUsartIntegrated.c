...
# 196 "build/vendor/unity/src/unity_internals.h"
...
void TaskScheduler_Init_CMockExpect(UNITY_UINT cmock_line);
...
void TaskScheduler_Update_CMockExpect(UNITY_UINT cmock_line, uint32 time);
...
void TaskScheduler_DoUsart_CMockIgnoreAndReturn(UNITY_UINT cmock_line, bool cmock_to_return);

void TaskScheduler_DoUsart_CMockStopIgnore(void);


void TaskScheduler_DoUsart_CMockExpectAndReturn(UNITY_UINT cmock_line, bool cmock_to_return);
...
void TaskScheduler_DoAdc_CMockIgnoreAndReturn(UNITY_UINT cmock_line, bool cmock_to_return);

void TaskScheduler_DoAdc_CMockStopIgnore(void);


void TaskScheduler_DoAdc_CMockExpectAndReturn(UNITY_UINT cmock_line, bool cmock_to_return);
...
# 86 "build/test/mocks/TestUsartIntegrated/MockTaskScheduler.h"
...
void Usart_ConfigureUsartIO_CMockExpect(UNITY_UINT cmock_line);
...
void Usart_EnablePeripheralClock_CMockExpect(UNITY_UINT cmock_line);
...
void Usart_Reset_CMockExpect(UNITY_UINT cmock_line);
...
void Usart_ConfigureMode_CMockExpect(UNITY_UINT cmock_line);
...
void Usart_SetBaudRateRegister_CMockExpect(UNITY_UINT cmock_line, uint8 baudRateRegisterSetting);
...
void Usart_Enable_CMockExpect(UNITY_UINT cmock_line);
...
# 110 "build/test/mocks/TestUsartIntegrated/MockUsartConfigurator.h"
#pragma GCC diagnostic pop
...
void Usart_PutChar_CMockExpect(UNITY_UINT cmock_line, char data);
...
# 50 "build/test/mocks/TestUsartIntegrated/MockUsartPutChar.h"
#pragma GCC diagnostic pop
...
void TemperatureFilter_Init_CMockExpect(UNITY_UINT cmock_line);
...
void TemperatureFilter_GetTemperatureInCelcius_CMockIgnoreAndReturn(UNITY_UINT cmock_line, float cmock_to_return);

void TemperatureFilter_GetTemperatureInCelcius_CMockStopIgnore(void);


void TemperatureFilter_GetTemperatureInCelcius_CMockExpectAndReturn(UNITY_UINT cmock_line, float cmock_to_return);
...
void TemperatureFilter_ProcessInput_CMockExpect(UNITY_UINT cmock_line, float temperature);
...
# 74 "build/test/mocks/TestUsartIntegrated/MockTemperatureFilter.h"
#pragma GCC diagnostic pop
...
# 13 "src/UsartBaudRateRegisterCalculator.h"
...
void UsartModel_CalculateBaudRateRegisterSetting_CMockIgnoreAndReturn(UNITY_UINT cmock_line, uint8 cmock_to_return);

void UsartModel_CalculateBaudRateRegisterSetting_CMockStopIgnore(void);


void UsartModel_CalculateBaudRateRegisterSetting_CMockExpectAndReturn(UNITY_UINT cmock_line, uint32 masterClock, uint32 baudRate, uint8 cmock_to_return);
...
# 50 "build/test/mocks/TestUsartIntegrated/MockUsartBaudRateRegisterCalculator.h"
#pragma GCC diagnostic pop
