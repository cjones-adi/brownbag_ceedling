# 0 "test/TestUsartBaudRateRegisterCalculator.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 0 "<command-line>" 2
# 1 "test/TestUsartBaudRateRegisterCalculator.c"
/* =========================================================================
...
# 9 "test/TestUsartBaudRateRegisterCalculator.c" 2
# 1 "src/Types.h" 1
/* =========================================================================
    Ceedling - Test-Centered Build System for C
    ThrowTheSwitch.org
...
# 10 "test/TestUsartBaudRateRegisterCalculator.c" 2
...
# 12 "src/UsartBaudRateRegisterCalculator.h" 2

uint8 UsartModel_CalculateBaudRateRegisterSetting(uint32 masterClock, uint32 baudRate);

# 11 "test/TestUsartBaudRateRegisterCalculator.c" 2
