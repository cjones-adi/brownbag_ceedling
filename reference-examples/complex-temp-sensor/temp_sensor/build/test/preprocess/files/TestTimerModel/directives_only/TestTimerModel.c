...
# 12 "src/TimerModel.h" 2

void TimerModel_UpdateTime(uint32 systemTime);

# 11 "test/TestTimerModel.c" 2
# 1 "build/test/mocks/TestTimerModel/MockTaskScheduler.h" 1
...
# 7 "build/test/mocks/TestTimerModel/MockTaskScheduler.h" 2
