...
# 12 "src/TimerHardware.h" 2

void TimerHardware_Init(void);

# 11 "test/TestTimerHardware.c" 2
# 1 "build/test/mocks/TestTimerHardware/MockTimerConfigurator.h" 1
...
# 7 "build/test/mocks/TestTimerHardware/MockTimerConfigurator.h" 2
