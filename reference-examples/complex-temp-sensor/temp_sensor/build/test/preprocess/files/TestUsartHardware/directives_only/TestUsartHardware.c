...
# 12 "src/UsartHardware.h" 2

void UsartHardware_Init(uint8 baudRateRegisterSetting);
void UsartHardware_TransmitString(char* data);

# 11 "test/TestUsartHardware.c" 2
# 1 "build/test/mocks/TestUsartHardware/MockUsartConfigurator.h" 1
...
# 7 "build/test/mocks/TestUsartHardware/MockUsartConfigurator.h" 2
...
# 12 "test/TestUsartHardware.c" 2
# 1 "build/test/mocks/TestUsartHardware/MockUsartPutChar.h" 1
/* AUTOGENERATED FILE. DO NOT EDIT. */
...
# 7 "build/test/mocks/TestUsartHardware/MockUsartPutChar.h" 2
