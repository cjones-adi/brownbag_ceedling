...
void Timer_EnablePeripheralClocks_CMockExpect(UNITY_UINT cmock_line);
...
void Timer_Reset_CMockExpect(UNITY_UINT cmock_line);
...
void Timer_ConfigureMode_CMockExpect(UNITY_UINT cmock_line);
...
void Timer_ConfigurePeriod_CMockExpect(UNITY_UINT cmock_line);
...
void Timer_EnableOutputPin_CMockExpect(UNITY_UINT cmock_line);
...
void Timer_Enable_CMockExpect(UNITY_UINT cmock_line);
...
void Timer_ConfigureInterruptHandler_CMockExpect(UNITY_UINT cmock_line);
...
void Timer_Start_CMockExpect(UNITY_UINT cmock_line);
...
# 134 "build/test/mocks/TestTimerIntegrated/MockTimerConfigurator.h"
...
# 13 "src/TimerInterruptHandler.h"
...
void Timer_SetSystemTime_CMockExpect(UNITY_UINT cmock_line, uint32 time);
...
void Timer_GetSystemTime_CMockIgnoreAndReturn(UNITY_UINT cmock_line, uint32 cmock_to_return);

void Timer_GetSystemTime_CMockStopIgnore(void);


void Timer_GetSystemTime_CMockExpectAndReturn(UNITY_UINT cmock_line, uint32 cmock_to_return);
...
void Timer_InterruptHandler_CMockExpect(UNITY_UINT cmock_line);
...
# 74 "build/test/mocks/TestTimerIntegrated/MockTimerInterruptHandler.h"
#pragma GCC diagnostic pop
...
# 86 "build/test/mocks/TestTimerIntegrated/MockTaskScheduler.h"
#pragma GCC diagnostic pop
