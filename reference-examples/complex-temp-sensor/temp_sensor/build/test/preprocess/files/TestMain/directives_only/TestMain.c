...
# 10 "test/TestMain.c" 2
# 1 "build/test/mocks/TestMain/MockExecutor.h" 1
...
# 7 "build/test/mocks/TestMain/MockExecutor.h" 2
...
#define Executor_Init_IgnoreAndReturn(cmock_retval) TEST_FAIL_MESSAGE("Executor_Init requires _Ignore (not AndReturn)");
...
#define Executor_Init_ExpectAndReturn(cmock_retval) TEST_FAIL_MESSAGE("Executor_Init requires _Expect (not AndReturn)");
...
#define Executor_Run_Ignore() TEST_FAIL_MESSAGE("Executor_Run requires _IgnoreAndReturn");
...
#define Executor_Run_Expect() TEST_FAIL_MESSAGE("Executor_Run requires _ExpectAndReturn");
...
typedef bool (* CMOCK_Executor_Run_CALLBACK)(int cmock_num_calls);
...
#define Executor_Run_StubWithCallback Executor_Run_Stub
