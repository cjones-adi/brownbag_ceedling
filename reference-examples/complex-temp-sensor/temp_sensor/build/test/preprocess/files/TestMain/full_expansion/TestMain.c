...
void Executor_Init_CMockExpect(UNITY_UINT cmock_line);
...
void Executor_Run_CMockIgnoreAndReturn(UNITY_UINT cmock_line, bool cmock_to_return);

void Executor_Run_CMockStopIgnore(void);


void Executor_Run_CMockExpectAndReturn(UNITY_UINT cmock_line, bool cmock_to_return);
...
# 62 "build/test/mocks/TestMain/MockExecutor.h"
