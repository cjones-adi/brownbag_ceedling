...
void UsartModel_GetBaudRateRegisterSetting_CMockIgnoreAndReturn(UNITY_UINT cmock_line, uint8 cmock_to_return);

void UsartModel_GetBaudRateRegisterSetting_CMockStopIgnore(void);


void UsartModel_GetBaudRateRegisterSetting_CMockExpectAndReturn(UNITY_UINT cmock_line, uint8 cmock_to_return);
...
void UsartModel_GetFormattedTemperature_CMockIgnoreAndReturn(UNITY_UINT cmock_line, char* cmock_to_return);

void UsartModel_GetFormattedTemperature_CMockStopIgnore(void);


void UsartModel_GetFormattedTemperature_CMockExpectAndReturn(UNITY_UINT cmock_line, char* cmock_to_return);
...
void UsartModel_GetWakeupMessage_CMockIgnoreAndReturn(UNITY_UINT cmock_line, char* cmock_to_return);

void UsartModel_GetWakeupMessage_CMockStopIgnore(void);


void UsartModel_GetWakeupMessage_CMockExpectAndReturn(UNITY_UINT cmock_line, char* cmock_to_return);
...
# 74 "build/test/mocks/TestUsartConductor/MockUsartModel.h"
...
void UsartHardware_Init_CMockExpect(UNITY_UINT cmock_line, uint8 baudRateRegisterSetting);
...
void UsartHardware_TransmitString_CMockExpect(UNITY_UINT cmock_line, char* data);
...
# 62 "build/test/mocks/TestUsartConductor/MockUsartHardware.h"
#pragma GCC diagnostic pop
...
# 86 "build/test/mocks/TestUsartConductor/MockTaskScheduler.h"
#pragma GCC diagnostic pop
