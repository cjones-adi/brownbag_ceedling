# 0 "test/test_led_control.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "test/test_led_control.c"
...
int led_control_set(led_color_t color, 
# 33 "src/led_control.h" 3 4
                                      _Bool 
# 33 "src/led_control.h"
                                           state);
...
# 40 "src/led_control.h" 3 4
_Bool 
# 40 "src/led_control.h"
    led_control_get(led_color_t color);
...
static inline int red_led_on(void) { return led_control_set(LED_COLOR_RED, 
# 56 "src/led_control.h" 3 4
                                                                              1
# 56 "src/led_control.h"
                                                                                  ); }
static inline int red_led_off(void) { return led_control_set(LED_COLOR_RED, 
# 57 "src/led_control.h" 3 4
                                                                              0
# 57 "src/led_control.h"
                                                                                   ); }
static inline int green_led_on(void) { return led_control_set(LED_COLOR_GREEN, 
# 58 "src/led_control.h" 3 4
                                                                              1
# 58 "src/led_control.h"
                                                                                  ); }
static inline int green_led_off(void){ return led_control_set(LED_COLOR_GREEN, 
# 59 "src/led_control.h" 3 4
                                                                              0
# 59 "src/led_control.h"
                                                                                   ); }
static inline int blue_led_on(void) { return led_control_set(LED_COLOR_BLUE, 
# 60 "src/led_control.h" 3 4
                                                                              1
# 60 "src/led_control.h"
                                                                                  ); }
static inline int blue_led_off(void) { return led_control_set(LED_COLOR_BLUE, 
# 61 "src/led_control.h" 3 4
                                                                              0
# 61 "src/led_control.h"
                                                                                   ); }
# 8 "test/test_led_control.c" 2
...
# 24 "test/test_led_control.c" 3 4
   ((void *)0)
# 24 "test/test_led_control.c"
...
void test_led_control_init_clears_state(void)
{
    ...
    red_led_on();
    led_control_init();
    do { if (!(led_control_get(LED_COLOR_RED))) { } else { UnityFail( ((" Expected FALSE Was TRUE")), (UNITY_UINT)((32))); } } while (0);
    do { if (!(led_control_get(LED_COLOR_GREEN))) { } else { UnityFail( ((" Expected FALSE Was TRUE")), (UNITY_UINT)((33))); } } while (0);
    do { if (!(led_control_get(LED_COLOR_BLUE))) { } else { UnityFail( ((" Expected FALSE Was TRUE")), (UNITY_UINT)((34))); } } while (0);
}
...
void test_red_led_on_sets_red(void)
{
    ...
    UnityAssertEqualNumber((UNITY_INT)((0)), (UNITY_INT)((result)), (
# 42 "test/test_led_control.c" 3 4
   ((void *)0)
# 42 "test/test_led_control.c"
   ), (UNITY_UINT)(42), UNITY_DISPLAY_STYLE_INT);
    do { if ((led_control_get(LED_COLOR_RED))) { } else { UnityFail( ((" Expected TRUE Was FALSE")), (UNITY_UINT)((43))); } } while (0);
}
...
void test_red_led_off_clears_red(void)
{
    ...
    UnityAssertEqualNumber((UNITY_INT)((0)), (UNITY_INT)((result)), (
# 50 "test/test_led_control.c" 3 4
   ((void *)0)
# 50 "test/test_led_control.c"
   ), (UNITY_UINT)(50), UNITY_DISPLAY_STYLE_INT);
    do { if (!(led_control_get(LED_COLOR_RED))) { } else { UnityFail( ((" Expected FALSE Was TRUE")), (UNITY_UINT)((51))); } } while (0);
}

void test_red_led_on_does_not_affect_green(void)
{
    red_led_on();
    do { if (!(led_control_get(LED_COLOR_GREEN))) { } else { UnityFail( ((" Expected FALSE Was TRUE")), (UNITY_UINT)((57))); } } while (0);
}
...
void test_green_led_on_sets_green(void)
{
    ...
    UnityAssertEqualNumber((UNITY_INT)((0)), (UNITY_INT)((result)), (
# 65 "test/test_led_control.c" 3 4
   ((void *)0)
# 65 "test/test_led_control.c"
   ), (UNITY_UINT)(65), UNITY_DISPLAY_STYLE_INT);
    do { if ((led_control_get(LED_COLOR_GREEN))) { } else { UnityFail( ((" Expected TRUE Was FALSE")), (UNITY_UINT)((66))); } } while (0);
}
...
void test_green_led_off_clears_green(void)
{
    ...
    UnityAssertEqualNumber((UNITY_INT)((0)), (UNITY_INT)((result)), (
# 73 "test/test_led_control.c" 3 4
   ((void *)0)
# 73 "test/test_led_control.c"
   ), (UNITY_UINT)(73), UNITY_DISPLAY_STYLE_INT);
    do { if (!(led_control_get(LED_COLOR_GREEN))) { } else { UnityFail( ((" Expected FALSE Was TRUE")), (UNITY_UINT)((74))); } } while (0);
}

void test_green_led_on_does_not_affect_red(void)
{
    green_led_on();
    do { if (!(led_control_get(LED_COLOR_RED))) { } else { UnityFail( ((" Expected FALSE Was TRUE")), (UNITY_UINT)((80))); } } while (0);
}
...
void test_blue_led_on_sets_blue(void)
{
    ...
    UnityAssertEqualNumber((UNITY_INT)((0)), (UNITY_INT)((result)), (
# 88 "test/test_led_control.c" 3 4
   ((void *)0)
# 88 "test/test_led_control.c"
   ), (UNITY_UINT)(88), UNITY_DISPLAY_STYLE_INT);
    do { if ((led_control_get(LED_COLOR_BLUE))) { } else { UnityFail( ((" Expected TRUE Was FALSE")), (UNITY_UINT)((89))); } } while (0);
}
...
void test_blue_led_off_clears_blue(void)
{
    blue_led_on();
    blue_led_off();
    do { if (!(led_control_get(LED_COLOR_BLUE))) { } else { UnityFail( ((" Expected FALSE Was TRUE")), (UNITY_UINT)((96))); } } while (0);
}
...
# 103 "test/test_led_control.c" 3 4
                                   0
# 103 "test/test_led_control.c"
                                        );
    led_control_toggle(LED_COLOR_BLUE);
    do { if ((led_control_get(LED_COLOR_BLUE))) { } else { UnityFail( ((" Expected TRUE Was FALSE")), (UNITY_UINT)((105))); } } while (0);

    led_control_toggle(LED_COLOR_BLUE);
    do { if (!(led_control_get(LED_COLOR_BLUE))) { } else { UnityFail( ((" Expected FALSE Was TRUE")), (UNITY_UINT)((108))); } } while (0);
}
...
void test_all_three_leds_independent(void)
{
    ...
    do { if ((led_control_get(LED_COLOR_RED))) { } else { UnityFail( ((" Expected TRUE Was FALSE")), (UNITY_UINT)((119))); } } while (0);
    do { if ((led_control_get(LED_COLOR_GREEN))) { } else { UnityFail( ((" Expected TRUE Was FALSE")), (UNITY_UINT)((120))); } } while (0);
    do { if ((led_control_get(LED_COLOR_BLUE))) { } else { UnityFail( ((" Expected TRUE Was FALSE")), (UNITY_UINT)((121))); } } while (0);

    red_led_off();
    do { if (!(led_control_get(LED_COLOR_RED))) { } else { UnityFail( ((" Expected FALSE Was TRUE")), (UNITY_UINT)((124))); } } while (0);
    do { if ((led_control_get(LED_COLOR_GREEN))) { } else { UnityFail( ((" Expected TRUE Was FALSE")), (UNITY_UINT)((125))); } } while (0);
    do { if ((led_control_get(LED_COLOR_BLUE))) { } else { UnityFail( ((" Expected TRUE Was FALSE")), (UNITY_UINT)((126))); } } while (0);
}
...
# 136 "test/test_led_control.c" 3 4
   ((void *)0)
# 136 "test/test_led_control.c"
   ), (UNITY_UINT)(136));
    UnityAssertBits((UNITY_INT)((LED_COLOR_GREEN)), (UNITY_INT)((LED_COLOR_GREEN)), (UNITY_INT)((state)), (
# 137 "test/test_led_control.c" 3 4
   ((void *)0)
# 137 "test/test_led_control.c"
   ), (UNITY_UINT)(137));
    UnityAssertBits((UNITY_INT)((LED_COLOR_BLUE)), (UNITY_INT)((0)), (UNITY_INT)((state)), (
# 138 "test/test_led_control.c" 3 4
   ((void *)0)
# 138 "test/test_led_control.c"
   ), (UNITY_UINT)(138));
}
# 148 "test/test_led_control.c"
void test_safety_logic_normal_conditions(void)
{
    ...
    do { if ((led_control_get(LED_COLOR_RED))) { } else { UnityFail( ((" Expected TRUE Was FALSE")), (UNITY_UINT)((160))); } } while (0);
    do { if (!(led_control_get(LED_COLOR_GREEN))) { } else { UnityFail( ((" Expected FALSE Was TRUE")), (UNITY_UINT)((161))); } } while (0);
}
...
void test_safety_logic_over_temp_only(void)
{
    ...
    do { if ((led_control_get(LED_COLOR_RED))) { } else { UnityFail( ((" Expected TRUE Was FALSE")), (UNITY_UINT)((176))); } } while (0);
    do { if (!(led_control_get(LED_COLOR_GREEN))) { } else { UnityFail( ((" Expected FALSE Was TRUE")), (UNITY_UINT)((177))); } } while (0);
}
...
void test_safety_logic_over_voltage_only(void)
{
    ...
    do { if ((led_control_get(LED_COLOR_RED))) { } else { UnityFail( ((" Expected TRUE Was FALSE")), (UNITY_UINT)((192))); } } while (0);
    do { if (!(led_control_get(LED_COLOR_GREEN))) { } else { UnityFail( ((" Expected FALSE Was TRUE")), (UNITY_UINT)((193))); } } while (0);
}
...
void test_safety_logic_both_thresholds_exceeded(void)
{
    ...
    do { if ((led_control_get(LED_COLOR_RED))) { } else { UnityFail( ((" Expected TRUE Was FALSE")), (UNITY_UINT)((208))); } } while (0);
    do { if ((led_control_get(LED_COLOR_GREEN))) { } else { UnityFail( ((" Expected TRUE Was FALSE")), (UNITY_UINT)((209))); } } while (0);
}
