...
# 18 "src/temp_sensor.h"
int temp_sensor_init(void);
# 30 "src/temp_sensor.h"
int temp_sensor_read(int32_t *temp_out);
# 75 "src/temp_sensor.h"
...
void i2c_hal_write_read_CMockIgnoreAndReturn(UNITY_UINT cmock_line, int cmock_to_return);

void i2c_hal_write_read_CMockStopIgnore(void);


void i2c_hal_write_read_CMockExpectAndReturn(UNITY_UINT cmock_line, uint8_t dev_addr, const uint8_t* tx, uint8_t tx_len, uint8_t* rx, uint8_t rx_len, int cmock_to_return);
...
void i2c_hal_reset_CMockIgnoreAndReturn(UNITY_UINT cmock_line, int cmock_to_return);

void i2c_hal_reset_CMockStopIgnore(void);


void i2c_hal_reset_CMockExpectAndReturn(UNITY_UINT cmock_line, int cmock_to_return);
...
# 62 "build/test/mocks/test_temp_sensor/mock_i2c_hal.h"
...
# 95 "test/test_temp_sensor.c" 3 4
   ((void *)0)
# 95 "test/test_temp_sensor.c"
...
# 96 "test/test_temp_sensor.c" 3 4
   ((void *)0)
# 96 "test/test_temp_sensor.c"
...
# 103 "test/test_temp_sensor.c" 3 4
   ((void *)0)
# 103 "test/test_temp_sensor.c"
   ), (UNITY_UINT)(103), UNITY_DISPLAY_STYLE_INT);
}
# 159 "test/test_temp_sensor.c"
...
void test_temp_sensor_read_handles_i2c_timeout_safely(void)
{
    ...
    UnityAssertEqualNumber((UNITY_INT)((-1)), (UNITY_INT)((ret)), (
# 218 "test/test_temp_sensor.c" 3 4
   ((void *)0)
# 218 "test/test_temp_sensor.c"
   ), (UNITY_UINT)(218), UNITY_DISPLAY_STYLE_INT);
    UnityAssertEqualNumber((UNITY_INT)(UNITY_INT32)((99999)), (UNITY_INT)(UNITY_INT32)((temp)), (
# 219 "test/test_temp_sensor.c" 3 4
   ((void *)0)
# 219 "test/test_temp_sensor.c"
...
# 256 "test/test_temp_sensor.c" 3 4
   ((void *)0)
# 256 "test/test_temp_sensor.c"
   ), (UNITY_UINT)(256), UNITY_DISPLAY_STYLE_INT);
    UnityAssertEqualNumber((UNITY_INT)(UNITY_INT32)((99999)), (UNITY_INT)(UNITY_INT32)((temp)), (
# 257 "test/test_temp_sensor.c" 3 4
   ((void *)0)
# 257 "test/test_temp_sensor.c"
